...
public class Entity
{
    ...
    public static final String E_MONEY = "money";               //货币
    public static final String E_MONEY_CNY = "money.cny";       //人民币/money.cny
    public static final String E_MONEY_HKD = "money.hkd";       //港元/money.hkd
    public static final String E_MONEY_USD = "money.usd";       //美元/money.usd
    public static final String E_MONEY_MOP = "money.mop";       //澳门元/money.mop
    public static final String E_MONEY_TWD = "money.twd";       //台币/money.twd
    public static final String E_MONEY_KWP = "money.kwp";       //朝鲜元/money.kwp
    public static final String E_MONEY_EUR = "money.eur";       //欧元/money.eur
    public static final String E_MONEY_KRW = "money.krw";       //韩元/money.krw
    public static final String E_MONEY_VND = "money.vnd";       //越南盾/money.vnd
    public static final String E_MONEY_JPY = "money.jpy";       //日元/money.jpy
    public static final String E_MONEY_SGD = "money.sgd";       //新加坡元/money.sgd
    public static final String E_MONEY_AUD = "money.aud";       //澳大利亚元/money.aud
    public static final String E_MONEY_THB = "money.thb";       //泰铢/money.thb
    public static final String E_MONEY_BUK = "money.buk";       //缅元/money.buk
    public static final String E_MONEY_INR = "money.inr";       //卢比/money.inr
    public static final String E_MONEY_GBP = "money.gbp";       //英镑/money.gbp
    public static final String E_MONEY_FRF = "money.frf";       //法郎/money.frf
    public static final String E_MONEY_CAD = "money.cad";       //加元/money.cad
    public static final String E_MONEY_DEM = "money.dem";       //马克/money.dem
    public static final String E_MONEY_ITL = "money.itl";       //里拉/money.itl
    public static final String E_MONEY_EGP = "money.egp";       //埃及镑/money.egp
    public static final String E_MONEY_NZD = "money.nzd";       //新西兰元/money.nzd
    public static final String E_MONEY_MYR = "money.myr";       //林吉特/money.myr
    public static final String E_MONEY_SUR = "money.sur";       //卢布/money.sur
    public static final String E_MONEY_ZAR = "money.zar";       //兰特/money.zar
    public static final String E_MONEY_PHP = "money.php";       //比索/money.php
    public static final String E_MONEY_MXP = "money.mxp";       //墨西哥比索/money.mxp
    public static final String E_MONEY_CUP = "money.cup";       //古巴比索/money.cup
    public static final String E_MONEY_SKK = "money.skk";       //克朗/money.skk
    public static final String E_MONEY_ISK = "money.isk";       //冰岛克朗/money.isk
    public static final String E_MONEY_SEK = "money.sek";       //瑞典克朗/money.sek
    public static final String E_MONEY_DKK = "money.dkk";       //丹麦克朗/money.dkk
    public static final String E_MONEY_NOK = "money.nok";       //挪威克朗/money.nok
    public static final String E_MONEY_CSK = "money.csk";       //捷克克朗/money.csk
