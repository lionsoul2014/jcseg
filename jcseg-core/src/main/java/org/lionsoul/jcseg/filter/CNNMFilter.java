...
public class CNNMFilter {
    ...
    /*
     * public static void main(String[] args) { //ADictionary.isCNNumeric('一');
     * int val = 0; long s = System.nanoTime(); //val =
     * cnNumericToArabic("三亿二千零六万七千五百六", true); //val =
     * cnNumericToArabic("一九九八", true); //val = cnNumericToArabic("二零一四", true);
     * //val = cnNumericToArabic("九百九十万零三", true); //val =
     * cnNumericToArabic("二零四八", true); long e = System.nanoTime();
