...
public class JcsegTest {
    ...
    public JcsegTest() throws JcsegException, IOException {
        ...
        // JcsegTaskConfig config = new
        // JcsegTaskConfig("/java/JavaSE/jcseg/jcseg.properties");
    ...
    public void segment(String str) throws IOException {
        ...
        while ((word = seg.next()) != null) {
            ...
            /*
             * sb.append("["); sb.append(word.getPosition()); sb.append("/");
             * sb.append(word.getLength()); sb.append("]");
             */
    ...
    public static void main(String[] args) throws JcsegException, IOException {
        ...
        try {
            demo.segment(str);
            System.out
                    .println("+--------jcseg chinese word segment demo-------+");
            System.out
                    .println("|- Suggest email: chenxin619315@gmail.com      |");
            System.out
                    .println("|- Run quit or exit to exit.                   |");
            System.out
                    .println("+----------------------------------------------+");
            do {
