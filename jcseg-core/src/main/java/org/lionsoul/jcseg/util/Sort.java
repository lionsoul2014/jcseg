...
public class Sort {
     ...
     * j) + 1 .<br />
     */
    private static final int[] GAPS = new int[] { 1, 5, 19, 41, 109, 209, 505,
            929, 2161, 8929, 16001, 36289, 64769, 146305, 260609,
            587521, // 1000th
            1045505, 2354689, 4188161, 9427969, 16764929, 37730305, 67084289,
            150958081, 268386305, 603906049, 1073643521, 2147483647 };
    ...
    private static <T extends Comparable<? super T>> void merge(T[] arr,
            T[] tmpArr, int lPos, int rPos, int rEnd) {
        int lEnd = rPos - 1;
        int tPos = lPos;
        int leftTmp = lPos;
     ...
     * @return T
     */
    private static <T extends Comparable<? super T>> T median(T[] arr,
            int left, int right) {
     ...
     */
    private static <T extends Comparable<? super T>> void quickSelect(T[] arr,
