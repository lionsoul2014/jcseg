...
/**
 * A normal queue base one single link but with hash index, so, it is fast for
 * searching
 * 
 * Currently build to replace the LinkList work pool of class
 * org.lionsoul.jcseg.ASegment
 * 
...
public class IHashQueue<T extends IWord> {
    ...
    /**
     * remove the node from the head and you should make sure the size is larger
     * than 0 by calling size() before you invoke the method or you will just
     * get null
     * 
     * @param T
     */
